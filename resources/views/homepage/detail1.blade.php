        ...
        <div class="card biodata-card">
            <div class="row g-0">
                <div class="col-md-4 text-center">
                    <img src="{{ asset('image/fotop.jpeg') }}" class="img-fluid rounded-start biodata-image mb-2"
                        alt="Foto Profil">
                    ...
                    <div class="card-body">
                        ...
                        <div class="biodata-grid">
                            <div class="biodata-box">
                                <strong>Nama Asli:</strong><br>M. Prabu Kiandamar Utoyo
                            </div>
                            ...
                            <div class="biodata-box"><strong>Golongan Darah:</strong><br>
                                <Obj>-</Obj>
                            </div>
                            ...
                            <div class="biodata-box"><strong>Alamat:</strong><br>Jl. Rawa Binangun II No.1, RT/RW 005/008,
                                Koja, Jakarta Utara, DKI Jakarta</div>
